...
void breakTime(time_t time, struct tm* tm);	 // break time_t into elements
time_t makeTime(const struct tm* tm);		 // convert time elements into time_t
